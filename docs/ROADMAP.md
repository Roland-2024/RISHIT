...
Task 01, Tasks 11–13, and supplemental Tasks 05A, 06A, and 08A are merged and `DONE`. **Task 15 — Payment-method validation** is in `REVIEW`; both evaluated candidate methods are NO-GO and Task 16 remains blocked. The Task 07 delivery request mapped to Task 11 because the original Task 07 was already merged. External legal/provider evidence work may proceed without changing blocked implementation tasks to `READY`.
...
| --- | --- | --- |
| B-FEE | **Reopened 2026-08-12:** buyer-side fees are unresolved. Product, finance, tax/fiscal, and Albanian legal owners must approve a versioned buyer fee, tax, display, refund, invoice, and public-wording policy. Seller listing and selling fees remain EUR 0; no Buyer Protection claim is approved. | 14, 17, 20, 35–36 |
